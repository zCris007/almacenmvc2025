...
<body>
    ...
    <h4 class="texto1"><i class="fa fa-sign-in"></i> &nbsp; Datos del usuario nuevo 
        ...
        <select name="prove" id="prove">
            <?php 
                do {                    
                $ideprov=$regprod['ide_usu'];
                $nomprov=$regprod['nom_usu'];
                $apeprov=$regprod['ape_usu'];
             ?>
             <option value=" <?php echo $ideprov ?> "> <?php echo $ideprov, ' - ', $nomprov, ' - ', $apeprov ?> </option>
             <?php 
        ...
        <input type="text" id="cant-pedida" name="cant-pedida" pattern="[0-9]{1,4}">

        <label for="cant-minima">Cantidad minima en inventario:</label>
        <input type="text" id="cant-minima" name="cant-minima" pattern="[0-9]{1,4}">
