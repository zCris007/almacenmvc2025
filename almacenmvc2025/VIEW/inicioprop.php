...
<head>
    ...
    <title>Login de propietario a Almacenmvc</title>
</head>
<body>
    ...
    <main>
    <br><br>
    <form action="../index.php?m=validaprop" method="post" class="formlog">
    <h4 class="texto1"><i class="fa fa-sign-in"></i> &nbsp; Datos de propietario para ingreso  
        ...
        <input type="hidden" id="tipousu" value="1" name="tipousu">
